//package com.cooksys.group_project_1_team_1;
//
//import com.cooksys.group_project_1_team_1.entities.*;
//import com.cooksys.group_project_1_team_1.repositories.*;
...
//
//        // Add reposts for existing tweets
//        // Repost of Tweet 1 by User 2
//        Tweet repostTweet1 = new Tweet();
//        repostTweet1.setAuthor(user2);
//        repostTweet1.setDeleted(false);
//        repostTweet1.setContent("Repost of tweet1 by user2");
//        repostTweet1.setPosted(new Timestamp(System.currentTimeMillis()));
//        repostTweet1.setRepostOf(tweet1);
//        tweetRepository.saveAndFlush(repostTweet1);
//
//        // Repost of Tweet 2 by User 3
//        Tweet repostTweet2 = new Tweet();
//        repostTweet2.setAuthor(user3);
//        repostTweet2.setDeleted(false);
//        repostTweet2.setContent("Repost of tweet2 by user3");
//        repostTweet2.setPosted(new Timestamp(System.currentTimeMillis()));
//        repostTweet2.setRepostOf(tweet2);
//        tweetRepository.saveAndFlush(repostTweet2);
//
//        // Update original tweets to include reposts
//        tweet1.setReposts(Arrays.asList(repostTweet1));
//        tweetRepository.saveAndFlush(tweet1);
//
//        tweet2.setReposts(Arrays.asList(repostTweet2));
//        tweetRepository.saveAndFlush(tweet2);
//
